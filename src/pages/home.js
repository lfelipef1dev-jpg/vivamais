...
function renderHome() {
  ...
  const hero = [
    ...
    '      </div>',
    '      <aside class="hero-schedule-card" aria-label="Próximos horários disponíveis">',
    '        <div class="hero-schedule-head">',
    '          ' + icons.clock,
    '          <h3>Próximos horários</h3>',
    '          <span class="badge badge-demo">Demo</span>',
    '        </div>',
    '        <ul class="hero-schedule-list">',
    '          <li><span class="hero-schedule-day">Hoje</span><span class="hero-schedule-time">14:30</span><span class="hero-schedule-spec">Cardiologia</span></li>',
    '          <li><span class="hero-schedule-day">Hoje</span><span class="hero-schedule-time">16:00</span><span class="hero-schedule-spec">Clínica Geral</span></li>',
    '          <li><span class="hero-schedule-day">Amanhã</span><span class="hero-schedule-time">09:30</span><span class="hero-schedule-spec">Dermatologia</span></li>',
    '        </ul>',
    '        <a class="hero-schedule-cta" href="agendamento.html">Ver todos os horários ' + icons.arrowRight + '</a>',
    '      </aside>',
    '    </div>',
    '  </div>',
    '</section>'
